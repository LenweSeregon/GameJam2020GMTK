namespace Equilibrium
{
	...
	public class PropertyConsumer : MonoBehaviour
	{
		...
		private void Update()
		{
			...
			{
				if(((m_property.Value + m_modificationValue) < m_property.MaxValue && m_modificationValue > 0) || (m_property.Value - m_modificationValue) > m_property.MinValue && m_modificationValue < 0)
				{
